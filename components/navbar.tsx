      ...
      <nav className='flex justify-between md:justify-center items-center gap-2'>
        ...
        <div className="flex items-center gap-2">
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="w-[225px] p-4 bg-lightOriginal dark:bg-gray-900">
              <SheetHeader>
              ...
              <div className="flex flex-col gap-2 font-semibold">
                {links.map((link, index) => (
                  <Link
                    ...
                    href={link.path}
                    className={`
                      flex gap-2 items-center rounded-md group cursor-pointer text-[#966554] dark:text-orange-300 tracking-tight
                      ${isActive(link.path) 
                        ? "bg-accentOriginal dark:bg-gray-800 text-white [&>span]:text-white" 
                        : "hover:bg-lightOriginal/50 dark:hover:bg-gray-800"
                      }
                    `}
                  >
                    <span className={`
                      ...
                      ${isActive(link.path)
                        ...
                        : "text-accentOriginal dark:text-orange-400 border-accentOriginal dark:border-orange-400 group-hover:bg-accentOriginal group-hover:text-white dark:group-hover:bg-gray-800"
                      }
