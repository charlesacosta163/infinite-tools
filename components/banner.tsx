...
export default function PromoBanner() {
  ...
  return (
    <Link 
      ...
      target="_blank"
      className="mt-2 p-4 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-700 dark:from-indigo-500 dark:to-purple-700 transition-all duration-300 group hover:from-green-500 hover:via-blue-600 hover:to-purple-700"
    >
      <div className="flex flex-col gap-2 items-center text-white">
        ...
        <p className="text-sm opacity-90 text-center">
          Version 1.7.3 OUT NOW!
        </p>

        {/* <span className="px-3 py-0.5 rounded-full text-[0.6rem] bg-red-400 text-white animate-bounce">Discounts Available!</span> */}
        <span className="flex items-center gap-1 text-sm mt-1 group-hover:gap-2 group-hover:bg-orange-600 transition-all duration-300 bg-orange-400 px-2 py-1 rounded-md w-full justify-center font-bold">
