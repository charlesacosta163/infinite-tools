...
export default function PromoBanner() {
  ...
  return (
    <Link 
      ...
      target="_blank"
      className="mt-2 p-4 rounded-xl bg-pink-300 transition-all duration-300 group"
    >
      <div className="flex flex-col gap-2 items-center text-white">
        ...
        <span className="flex items-center gap-1 text-sm font-medium mt-1 group-hover:gap-2 group-hover:bg-pink-500 transition-all duration-300 bg-pink-400 px-2 py-1 rounded-md w-full flex justify-center">
